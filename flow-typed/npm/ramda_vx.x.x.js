...
declare module ramda {
  ...
  declare type BinaryFn<A, B, R> = ((a: A, b: B) => R) & ((a: A) => (
    b: B
  ) => R);
  ...
  declare type CurriedFunction3<T1, T2, T3, R> = ((
    ...
    t2: T2,
    t3: T3
  ) => R) & ((t1: T1, t2: T2, ...rest: Array<void>) => (t3: T3) => R) & ((
    t1: T1,
    ...rest: Array<void>
  ) => CurriedFunction2<T2, T3, R>);
  declare type CurriedFunction4<T1, T2, T3, T4, R> = ((
    t1: T1,
    t2: T2,
    t3: T3,
    t4: T4
  ) => R) & ((t1: T1, t2: T2, t3: T3, ...rest: Array<void>) => (
    t4: T4
  ) => R) & ((
    t1: T1,
    t2: T2,
    ...rest: Array<void>
  ) => CurriedFunction2<T3, T4, R>) & ((
    t1: T1,
    ...rest: Array<void>
  ) => CurriedFunction3<T2, T3, T4, R>);
  declare type CurriedFunction5<T1, T2, T3, T4, T5, R> = ((
    t1: T1
  ) => CurriedFunction4<T2, T3, T4, T5, R>) & ((
    t1: T1,
    t2: T2
  ) => CurriedFunction3<T3, T4, T5, R>) & ((
    t1: T1,
    t2: T2,
    t3: T3
  ) => CurriedFunction2<T4, T5, R>) & ((t1: T1, t2: T2, t3: T3, t4: T4) => (
    t5: T5
  ...
  declare type CurriedFunction6<T1, T2, T3, T4, T5, T6, R> = ((
    ...
    t1: T1,
    t2: T2
  ) => CurriedFunction4<T3, T4, T5, T6, R>) & ((
    t1: T1,
    t2: T2,
    t3: T3
  ) => CurriedFunction3<T4, T5, T6, R>) & ((
    t1: T1,
    t2: T2,
    t3: T3,
    t4: T4
  ) => CurriedFunction2<T5, T6, R>) & ((
    t1: T1,
    t2: T2,
    t3: T3,
    t4: T4,
    t5: T5
  ) => (t6: T6) => R) & ((t1: T1, t2: T2, t3: T3, t4: T4, t5: T5, t6: T6) => R);
  ...
  ) => CurriedFunction2<T1, T2, TResult>) & (<T1, T2, T3, TResult>(
    fn: (a: T1, b: T2, c: T3) => TResult
  ) => CurriedFunction3<T1, T2, T3, TResult>) & (<T1, T2, T3, T4, TResult>(
    fn: (a: T1, b: T2, c: T3, d: T4) => TResult
  ) => CurriedFunction4<T1, T2, T3, T4, TResult>) & (<T1, T2, T3, T4, T5, TResult>(
    fn: (a: T1, b: T2, c: T3, d: T4, e: T5) => TResult
  ) => CurriedFunction5<T1, T2, T3, T4, T5, TResult>) & (<T1, T2, T3, T4, T5, T6, TResult>(
  ...
  declare type Filter = (<K, V, T: Array<V> | { [key: K]: V }>(
    ...
    xs: T
  ) => T) & (<K, V, T: Array<V> | { [key: K]: V }>(fn: UnaryPredicateFn<V>) => (
    xs: T
  ) => T);
  ...
  */
  ...
  // *List
  declare function adjust<T>(fn: (a: T) => T, ...rest: Array<void>): (
    index: number,
    ...rest: Array<void>
  ) => (src: Array<T>) => Array<T>;
  ...
  declare function all<T>(fn: UnaryPredicateFn<T>, ...rest: Array<void>): (
    xs: Array<T>
  ) => boolean;

  declare function any<T>(fn: UnaryPredicateFn<T>, xs: Array<T>): boolean;
  declare function any<T>(fn: UnaryPredicateFn<T>, ...rest: Array<void>): (
    xs: Array<T>
  ) => boolean;

  declare function aperture<T>(n: number, xs: Array<T>): Array<Array<T>>;
  declare function aperture<T>(n: number, ...rest: Array<void>): (
    xs: Array<T>
  ) => Array<Array<T>>;

  declare function append<E>(x: E, xs: Array<E>): Array<E>;
  declare function append<E>(x: E, ...rest: Array<void>): (
    xs: Array<E>
  ) => Array<E>;

  declare function prepend<E>(x: E, xs: Array<E>): Array<E>;
  declare function prepend<E>(x: E, ...rest: Array<void>): (
    xs: Array<E>
  ) => Array<E>;
  ...
  declare function groupBy<T>(fn: (x: T) => string, xs: Array<T>): {
    [key: string]: Array<T>,
  };
  declare function groupBy<T>(fn: (x: T) => string, ...rest: Array<void>): (
    xs: Array<T>
  ) => { [key: string]: Array<T> };
  ...
  declare function indexOf<E>(x: E, ...rest: Array<void>): (
    xs: Array<E>
  ) => number;
  ...
  declare function insert<T>(index: number, ...rest: Array<void>): (
    elem: T
  ) => (src: Array<T>) => Array<T>;
  declare function insert<T>(index: number, elem: T, ...rest: Array<void>): (
    src: Array<T>
  ) => Array<T>;
  declare function insert<T>(index: number, elem: T, src: Array<T>): Array<T>;

  declare function insertAll<T, S>(index: number, ...rest: Array<void>): (
    elem: Array<S>
  ...
  declare function join(x: string, ...rest: Array<void>): (
    xs: Array<any>
  ) => string;
  ...
  declare function none<T>(fn: UnaryPredicateFn<T>, ...rest: Array<void>): (
    xs: Array<T>
  ) => boolean;
  ...
  declare function forEach<T, V>(fn: (x: T) => ?V, ...rest: Array<void>): (
    xs: Array<T>
  ) => Array<T>;

  declare function lastIndexOf<E>(x: E, xs: Array<E>): number;
  declare function lastIndexOf<E>(x: E, ...rest: Array<void>): (
    xs: Array<E>
  ) => number;

  declare function map<T, R>(fn: (x: T) => R, xs: Array<T>): Array<R>;
  declare function map<T, R, S: { map: Function }>(fn: (x: T) => R, xs: S): S;
  declare function map<T, R>(fn: (x: T) => R, ...rest: Array<void>): ((
    xs: { [key: string]: T }
  ) => { [key: string]: R }) & ((xs: Array<T>) => Array<R>);
  declare function map<T, R, S: { map: Function }>(
    fn: (x: T) => R,
    ...rest: Array<void>
  ): ((xs: S) => S) & ((xs: S) => S);
  declare function map<T, R>(fn: (x: T) => R, xs: { [key: string]: T }): {
    [key: string]: R,
  };
  ...
  declare function intersperse<E>(x: E, ...rest: Array<void>): (
    xs: Array<E>
  ) => Array<E>;
  ...
  declare function pluck<V, K: string | number, T: Array<
    | Array<V>
    | { [key: string]: V }>>(k: K, xs: T): Array<V>;
  declare function pluck<V, K: string | number, T: Array<
    | Array<V>
    | { [key: string]: V }>>(k: K, ...rest: Array<void>): (xs: T) => Array<V>;

  declare var range: CurriedFunction2<number, number, Array<number>>;

  declare function remove<T>(from: number, ...rest: Array<void>): ((
    to: number,
    ...rest: Array<void>
  ) => (src: Array<T>) => Array<T>) & ((to: number, src: Array<T>) => Array<T>);
  declare function remove<T>(from: number, to: number, ...rest: Array<void>): (
    src: Array<T>
  ) => Array<T>;
  declare function remove<T>(from: number, to: number, src: Array<T>): Array<T>;

  declare function repeat<T>(x: T, times: number): Array<T>;
  declare function repeat<T>(x: T, ...rest: Array<void>): (
    times: number
  ) => Array<T>;
  ...
  declare function times<T>(fn: (i: number) => T, ...rest: Array<void>): (
    n: number
  ) => Array<T>;
  ...
  declare function takeWhile<V, T: Array<V>>(fn: UnaryPredicateFn<V>): (
    xs: T
  ) => T;
  ...
  declare function uniqBy<T, V>(fn: (x: T) => V, ...rest: Array<void>): (
    xs: Array<T>
  ) => Array<T>;
  ...
  declare function update<T>(index: number, ...rest: Array<void>): ((
    elem: T,
    ...rest: Array<void>
  ) => (src: Array<T>) => Array<T>) & ((elem: T, src: Array<T>) => Array<T>);
  declare function update<T>(index: number, elem: T, ...rest: Array<void>): (
    src: Array<T>
  ) => Array<T>;
  ...
  declare function without<T>(xs: Array<T>, ...rest: Array<void>): (
    src: Array<T>
  ) => Array<T>;

  declare function xprod<T, S>(xs: Array<T>, ys: Array<S>): Array<[T, S]>;
  declare function xprod<T, S>(xs: Array<T>, ...rest: Array<void>): (
    ys: Array<S>
  ) => Array<[T, S]>;

  declare function zip<T, S>(xs: Array<T>, ys: Array<S>): Array<[T, S]>;
  declare function zip<T, S>(xs: Array<T>, ...rest: Array<void>): (
    ys: Array<S>
  ) => Array<[T, S]>;

  declare function zipObj<T: string, S>(xs: Array<T>, ys: Array<S>): {
    [key: T]: S,
  };
  declare function zipObj<T: string, S>(xs: Array<T>, ...rest: Array<void>): (
    ys: Array<S>
  ) => { [key: T]: S };
  ...
  declare function mergeAll(objs: Array<{ [key: string]: any }>): {
    [key: string]: any,
  };
  ...
  declare function reduce<A, B>(
    fn: (acc: A, elem: B) => A,
    ...rest: Array<void>
  ): ((init: A, xs: Array<B>) => A) & ((init: A, ...rest: Array<void>) => (
    xs: Array<B>
  ) => A);
  declare function reduce<A, B>(
    fn: (acc: A, elem: B) => A,
  ...
  declare function reduceBy<A, B>(
    ...
    acc: B,
    ...rest: Array<void>
  ): ((keyFn: (elem: A) => string, ...rest: Array<void>) => (xs: Array<A>) => {
    [key: string]: B,
  ...
  declare function splitAt<V, T: Array<V> | string>(i: number): (
    xs: T
  ) => [T, T];
  ...
  declare function eqBy<A, B>(fn: (x: A) => B, ...rest: Array<void>): ((
    x: A,
    y: A
  ) => boolean) & ((x: A, ...rest: Array<void>) => (y: A) => boolean);
  declare function eqBy<A, B>(fn: (x: A) => B, x: A, ...rest: Array<void>): (
    y: A
  ) => boolean;
  declare function eqBy<A, B>(fn: (x: A) => B, x: A, y: A): boolean;

  declare function propEq(prop: string, ...rest: Array<void>): ((
    val: *,
    o: { [k: string]: * }
  ) => boolean) & ((val: *, ...rest: Array<void>) => (
    o: { [k: string]: * }
  ) => boolean);
  declare function propEq(prop: string, val: *, ...rest: Array<void>): (
    o: { [k: string]: * }
  ) => boolean;
  declare function propEq(prop: string, val: *, o: { [k: string]: * }): boolean;

  declare function pathEq(path: Array<string>, ...rest: Array<void>): ((
    val: any,
    o: Object
  ) => boolean) & ((val: any, ...rest: Array<void>) => (o: Object) => boolean);
  ...
  declare function countBy<T>(fn: (x: T) => string, ...rest: Array<void>): (
    list: Array<T>
  ) => { [key: string]: number };
  declare function countBy<T>(fn: (x: T) => string, list: Array<T>): {
    [key: string]: number,
  };

  declare function difference<T>(xs1: Array<T>, ...rest: Array<void>): (
    xs2: Array<T>
  ) => Array<T>;
  ...
  declare function intersectionWith<T>(
    fn: BinaryPredicateFn<T>,
    ...rest: Array<void>
  ): ((x: Array<T>, y: Array<T>) => Array<T>) & ((x: Array<T>) => (
    y: Array<T>
  ) => Array<T>);
  declare function intersectionWith<T>(
    fn: BinaryPredicateFn<T>,
  ...
  declare function maxBy<T, V>(fn: (x: T) => V, ...rest: Array<void>): ((
    x: T,
    y: T
  ) => T) & ((x: T) => (y: T) => T);
  declare function maxBy<T, V>(fn: (x: T) => V, x: T, ...rest: Array<void>): (
    y: T
  ) => T;
  ...
  declare function minBy<T, V>(fn: (x: T) => V, ...rest: Array<void>): ((
    x: T,
    y: T
  ) => T) & ((x: T) => (y: T) => T);
  declare function minBy<T, V>(fn: (x: T) => V, x: T, ...rest: Array<void>): (
    y: T
  ) => T;
  declare function minBy<T, V>(fn: (x: T) => V, x: T, y: T): T;

  declare function sortBy<T, V>(fn: (x: T) => V, ...rest: Array<void>): (
    x: Array<T>
  ) => Array<T>;
  declare function sortBy<T, V>(fn: (x: T) => V, x: Array<T>): Array<T>;

  declare function symmetricDifference<T>(x: Array<T>, ...rest: Array<void>): (
    y: Array<T>
  ) => Array<T>;
  ...
  declare function union<T>(x: Array<T>, ...rest: Array<void>): (
    y: Array<T>
  ) => Array<T>;
  ...
  declare function assoc<T, S>(key: string, val: T, ...args: Array<void>): (
    src: { [k: string]: S }
  ) => { [k: string]: S | T };
  declare function assoc<T, S>(key: string, val: T, src: { [k: string]: S }): {
    [k: string]: S | T,
  };
  ...
  declare function assocPath<T, S>(key: Array<string>, ...args: Array<void>): ((
    val: T,
    ...rest: Array<void>
  ) => (src: { [k: string]: S }) => { [k: string]: S | T }) & ((val: T) => (
    src: { [k: string]: S }
  ) => { [k: string]: S | T });
  ...
  declare function dissoc<T>(key: string, val: T, ...args: Array<void>): (
    src: { [k: string]: T }
  ) => { [k: string]: T };
  declare function dissoc<T>(key: string, val: T, src: { [k: string]: T }): {
    [k: string]: T,
  };
  ...
  declare function dissocPath<T>(key: Array<string>, ...args: Array<void>): ((
    val: T,
    ...rest: Array<void>
  ) => (src: { [k: string]: T }) => { [k: string]: T }) & ((val: T) => (
    src: { [k: string]: T }
  ) => { [k: string]: T });
  ...
  declare function eqProps(key: string, ...args: Array<void>): ((
    o1: Object,
    ...rest: Array<void>
  ) => (o2: Object) => boolean) & ((o1: Object, o2: Object) => boolean);
  declare function eqProps(key: string, o1: Object, ...args: Array<void>): (
    o2: Object
  ) => boolean;
  ...
  */
  ...
  declare function mergeAll<T>(os: Array<{ [k: string]: T }>): {
    [k: string]: T,
  };

  declare function mergeWith<T, S, R, A: { [k: string]: T }, B: {
    [k: string]: S,
  }>(fn: (v1: T, v2: S) => R): ((o1: A, ...rest: Array<void>) => (
    o2: B
  ) => A & B) & ((o1: A, o2: B) => A & B);
  declare function mergeWith<T, S, R, A: { [k: string]: T }, B: {
    [k: string]: S,
  }>(fn: (v1: T, v2: S) => R, o1: A, o2: B): A & B;
  declare function mergeWith<T, S, R, A: { [k: string]: T }, B: {
    [k: string]: S,
  }>(fn: (v1: T, v2: S) => R, o1: A, ...rest: Array<void>): (o2: B) => A & B;

  declare function mergeWithKey<T, S, R, A: { [k: string]: T }, B: {
    [k: string]: S,
  }>(fn: (key: $Keys<A & B>, v1: T, v2: S) => R): ((
    o1: A,
    ...rest: Array<void>
  ) => (o2: B) => A & B) & ((o1: A, o2: B) => A & B);
  declare function mergeWithKey<T, S, R, A: { [k: string]: T }, B: {
    [k: string]: S,
  }>(fn: (key: $Keys<A & B>, v1: T, v2: S) => R, o1: A, o2: B): A & B;
  declare function mergeWithKey<T, S, R, A: { [k: string]: T }, B: {
    [k: string]: S,
  }>(fn: (key: $Keys<A & B>, v1: T, v2: S) => R, o1: A, ...rest: Array<void>): (
    o2: B
  ) => A & B;

  declare function objOf<T>(key: string, ...rest: Array<void>): (val: T) => {
    [key: string]: T,
  };
  ...
  declare function pick<A>(keys: Array<string>, ...rest: Array<void>): (
    val: { [key: string]: A }
  ) => { [key: string]: A };
  declare function pick<A>(keys: Array<string>, val: { [key: string]: A }): {
    [key: string]: A,
  };

  declare function pickAll<A>(keys: Array<string>, ...rest: Array<void>): (
    val: { [key: string]: A }
  ) => { [key: string]: ?A };
  declare function pickAll<A>(keys: Array<string>, val: { [key: string]: A }): {
    [key: string]: ?A,
  };
  ...
  declare function project<T>(keys: Array<string>, ...rest: Array<void>): (
  ...
  declare function ap<T, V>(fns: Array<(x: T) => V>, ...rest: Array<void>): (
    xs: Array<T>
  ) => Array<V>;
  ...
  declare function binary<T>(fn: (...args: Array<any>) => T): (
    x: any,
    y: any
  ) => T;

  declare function bind<T>(fn: (...args: Array<any>) => any, thisObj: T): (
    ...args: Array<any>
  ) => any;
  ...
  declare function comparator<T>(fn: BinaryPredicateFn<T>): (
    x: T,
    y: T
  ) => number;

  // TODO add tests
  declare function construct<T>(ctor: Class<GenericContructor<T>>): (
    x: T
  ) => GenericContructor<T>;
  ...
  ): ((arg1: B, arg0: A, ...rest: Array<void>) => (
    arg2: C,
    arg3: D
  ) => TResult) & ((arg1: B, arg0: A, arg2: C, arg3: D) => TResult);
  declare function flip<A, B, C, D, E, TResult>(
    ...
    arg3: D,
    arg4: E
  ) => TResult) & ((arg1: B, arg0: A, arg2: C, arg3: D, arg4: E) => TResult);
  ...
  declare function juxt<T, S>(fns: Array<(...args: Array<S>) => T>): (
    ...args: Array<S>
  ) => Array<T>;
  ...
  declare function nAry<T>(arity: number, fn: (...args: Array<any>) => T): (
    ...args: Array<any>
  ) => T;
  ...
  declare function unapply<T, V>(fn: (xs: Array<T>) => V): (
    ...args: Array<T>
  ) => V;
  ...
  declare function allPass<T>(fns: Array<(...args: Array<T>) => boolean>): (
    ...args: Array<T>
  ) => boolean;

  declare function and(x: boolean, ...rest: Array<void>): (
    y: boolean
  ) => boolean;
  declare function and(x: boolean, y: boolean): boolean;

  declare function anyPass<T>(fns: Array<(...args: Array<T>) => boolean>): (
    ...args: Array<T>
  ) => boolean;
  ...
  declare function complement<T>(x: (...args: Array<T>) => boolean): (
    ...args: Array<T>
  ) => boolean;
  ...
  declare function defaultTo<T, V>(d: T, ...rest: Array<void>): (x: ?V) =>
    | V
    | T;
  ...
  declare function ifElse<A, B, C>(
    ...
    ...rest: Array<void>
  ): ((f1: (...args: Array<A>) => B, ...rest: Array<void>) => (
    f2: (...args: Array<A>) => C
  ) => (...args: Array<A>) => B | C) & ((
    f1: (...args: Array<A>) => B,
    f2: (...args: Array<A>) => C
  ...
  declare function pathSatisfies<T>(
    cond: (x: T) => boolean,
    ...rest: Array<void>
  ): ((path: Array<string>, ...rest: Array<void>) => (
    o: NestedObject<T>
  ) => boolean) & ((path: Array<string>, o: NestedObject<T>) => boolean);
  ...
  declare function propSatisfies<T>(
    cond: (x: T) => boolean,
    ...rest: Array<void>
  ): ((prop: string, ...rest: Array<void>) => (
    o: NestedObject<T>
  ) => boolean) & ((prop: string, o: NestedObject<T>) => boolean);
