declare module 'recompose' {
  ...
  */
  ...
  declare function compose<A, B, C, D, E, F, G, H, I, J, K, L, M, O, P, Q>(
    pq: Fn1<P, Q>,
    op: Fn1<O, P>,
    mo: Fn1<M, O>,
    lm: Fn1<L, M>,
  ...
  declare function compose<A, B, C, D, E, F, G, H, I, J, K, L, M, O, P>(
    op: Fn1<O, P>,
    mo: Fn1<M, O>,
    lm: Fn1<L, M>,
    kl: Fn1<K, L>,
  ...
  declare function compose<A, B, C, D, E, F, G, H, I, J, K, L, M, O>(
    mo: Fn1<M, O>,
    lm: Fn1<L, M>,
    kl: Fn1<K, L>,
    jk: Fn1<J, K>,
  ...
  declare function compose<A, B, C, D, E, F, G, H, I, J, K, L, M>(
    lm: Fn1<L, M>,
    kl: Fn1<K, L>,
    jk: Fn1<J, K>,
    ij: Fn1<I, J>,
  ...
  declare function compose<A, B, C, D, E, F, G, H, I, J, K, L>(
    kl: Fn1<K, L>,
    jk: Fn1<J, K>,
    ij: Fn1<I, J>,
    hi: Fn1<H, I>,
  ...
  declare function compose<A, B, C, D, E, F, G, H, I, J, K>(
    jk: Fn1<J, K>,
    ij: Fn1<I, J>,
    hi: Fn1<H, I>,
    gh: Fn1<G, H>,
  ...
  declare function mapProps<A, B>(propsMapper: (ownerProps: B) => A): HOC<A, B>;

  declare function withProps<A, B>(
    createProps: (ownerProps: B) => A
  ): HOC<A & B, B>;
  declare function withProps<A, B>(createProps: A): HOC<A & B, B>;
  ...
  declare function withHandlers<B, A: {
    [key: string]: (props: B) => Function,
  }>(handlerCreators: A): HOC<A & B, B>;
  ...
  declare function flattenProp<A, B>(propName: $Keys<B>): HOC<A, B>;
  ...
  declare function shouldUpdate<A>(test: SCU<A>): HOC<A, A>;
  ...
  declare function getContext<A, B, C: Object>(contextTypes: C): HOC<A & {
    [key: $Keys<C>]: any,
  }, B>;

  declare function lifecycle<A>(spec: Object): HOC<A, A>;

  declare function toClass<A>(): HOC<A, A>;

  declare function setStatic<A>(key: string, value: any): HOC<A, A>;

  declare function setDisplayName<A>(displayName: string): HOC<A, A>;

  declare function getDisplayName<A>(C: Component<A>): string;

  declare function wrapDisplayName<A>(
    C: Component<A>,
    wrapperName: string
  ): string;
  ...
  declare function createEagerFactory<A>(type: Component<A> | string): (
    props: ?A,
    children?: ?ReactNode
  ) => React$Element<any>;
